...
export default function TicketClient({ initialTickets, userRole }: { initialTickets: any[]; userRole?: string; }) {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {/* Scrollable Filter Chips untuk HP */}
            ...
            {processedTickets.map((ticket) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-50">
                  <span className="inline-flex items-center gap-1 px-2 py-1 bg-slate-50 text-slate-500 rounded-md text-[10px] font-bold border border-slate-100">
