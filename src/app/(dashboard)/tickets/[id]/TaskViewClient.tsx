// hl-sys/src/app/(dashboard)/tickets/[id]/TaskViewClient.tsx
"use client";
...
export default function TaskViewClient({ initialTicket, pics, currentUser }: { initialTicket: any, pics: any[], currentUser: any }) {
  ...
  // Logika Filter PIC untuk Modal Edit
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-10">
      <div className="flex items-center justify-between">
        ...
        {/* Tombol Edit hanya untuk OPR / ADM */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Tombol Action untuk PIC / OPR mengubah status jalan/selesai */}
