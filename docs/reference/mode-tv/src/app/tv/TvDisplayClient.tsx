...
/* ============================================================
   HELPER WAKTU (selalu WIB)
   ============================================================ */
const WIB_OFFSET_MS = 7 * 60 * 60 * 1000;
const wibKey = (d: Date) => new Date(d.getTime() + WIB_OFFSET_MS).toISOString().slice(0, 10);
...
export default function TvDisplayClient({ initialData }: { initialData: TvData | null }) {
  ...
  const slides: SlideKey[] = hasMilestones
    ? ['ringkasan', 'cabang', 'terbaru', 'staf', 'selamat']
    : ['ringkasan', 'cabang', 'terbaru', 'staf'];
