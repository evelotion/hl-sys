...
async function main() {
  ...
  const usersData = [
    ...
    { initial: 'RIN', name: 'Kamirina', phone: '6281317737283', email: 'kamirina@bcasyariah.co.id', role: 'PIC_LOGISTIK' }, // <-- Digenerate sesuai format
    ...
    { initial: 'SML', name: 'Semuel Robert Lontoh', phone: '6285750337669', email: 'semuel_robert@bcasyariah.co.id', role: 'PIC_LOGISTIK' }, // <-- Digenerate sesuai format
    { initial: 'ADM', name: 'ADMIN', phone: '6285179677792', email: 'admin_logistik@bcasyariah.co.id', role: 'OPERATOR' }, // <-- Digenerate sesuai format
  ];
